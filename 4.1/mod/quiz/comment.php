 ...
 * Changes were made by Vishal Rao and Tausif Iqbal from line number 114-162
 * No additional changes made by Asha Jose and Parvathy S Kumar
 */
...
//Vishal Rao and Tausif Iqbal changes begins here
...
foreach ($files as $file) {
    ...
    $filename = explode('/', $url);  // split based on "/" and take last element; this would be filename
